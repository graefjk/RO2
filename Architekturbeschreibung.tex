...
\section{Aufgabenaufteilung}
    ...
    \begin{longtable}{||c|c|c|c|c|c|c|c|c||}
        \hline \hline
         ...
         1 & Instruktionen & * &  &  & * &  &  &\\ \hline
         2 & Blockdiagram &  &  & * &  &  & * & \\ \hline
         3 & Register &  & * &  &  &  &  &\\ \hline
         4 & RAM & * &  &  &  &  &  &\\ \hline
         5 & PC &  &  &  &  &  & & * \\ \hline
         6 & I/O &  &  & *  &  &  & &  \\ \hline
         7 & ALU Aritmetik &  &  &  & * & * & * & \\ \hline
         7 & ALU Logik &  &  &  & * & * & * & \\ \hline
         7 & ALU Shift &  &  &  & * & * & * & \\ \hline
         7 & \makecell{ALU Verifikation \\ 10 einfache Testfälle }&  &  &  & * & * & * & \\ \hline
         8 & Decoder &  &  &  & * & * &  & \\ \hline
         9 & Assembler &  &  &  & * &  &  & \\ \hline
         10 & Test Register &  &  & * &  &  &  &\\ \hline
         11 & Test RAM &  &  &  &  &  &  & *\\ \hline
         12 & Test PC &  &  &  &  &  & * &  \\ \hline
         13 & Test I/O &  &  &  & * &  & &  \\ \hline
         14 & Test ALU & * &  &  &  &  &  & \\ \hline
         15 & Test Decoder &  & * &  &  &  &  & \\ \hline
    \end{longtable}
